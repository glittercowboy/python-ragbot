...
class ClaudeService:
    def __init__(self):
        ...
        self.model = "claude-3-7-sonnet-20250219"  # You can change to a different Claude model
    ...
    async def generate_game_question(self) -> str:
        ...
        try:
            ...
            return "What's something that you've changed your mind about recently, and why?"  # Fallback question